...
class LaravelLoggerController extends BaseController
{
    ...
    public function clearActivityLog(Request $request)
    {
        ...
        return redirect()->route('admin.activity.index')->withMessage(trans('LaravelLogger::laravel-logger.messages.logClearedSuccessfuly'));
    }
    ...
    public function destroyActivityLog(Request $request)
    {
        ...
        return redirect()->route('admin.activity.index')->withMessage(trans('LaravelLogger::laravel-logger.messages.logDestroyedSuccessfuly'));
    }
    ...
    public function restoreClearedActivityLog(Request $request)
    {
        ...
        return redirect()->route('admin.activity.index')->withMessage(trans('LaravelLogger::laravel-logger.messages.logRestoredSuccessfuly'));
    }
